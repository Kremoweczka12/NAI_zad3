...
//double invoke_given_func(std::function f, std::vector <double> v){
//    double result = f(v);
//    return result;
//}
...
int main(int argc, char **argv) {
    std::vector<double> my_result = get_result(restrigin_function, -5.12, 5.12, 1000000);
    std::cout << "stochastic: " << std::endl;
    std::cout << my_result[0] << std::endl;
    std::cout << my_result[1] << std::endl;
    std::vector<double> annealing_result = simulate_annealing(restrigin_function, -5.12, 5.12, 1000000);
    std::cout << "annealing result: " << std::endl;
    std::cout << annealing_result[0] << std::endl;
    std::cout << annealing_result[1] << std::endl;
    std::vector<double> hill_climb_result = hill_climbing(restrigin_function, -5.12, 5.12, 1000000);
